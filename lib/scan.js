...
module.exports = function createScan(auth) {
  ...
  const YAHOO_BASE = process.env.YAHOO_PROXY_URL
    ? process.env.YAHOO_PROXY_URL.replace(/\/$/, '')
  ...
  const UNIVERSES = {
    ...
    brasil: [
      { t: 'BOVA11.SA', n: 'IBOVESPA ETF', s: 'Índice', _regime: true },
      ...
      { t: 'ENGI11.SA', n: 'Energisa UNT', s: 'Utilidades' },
      ...
      { t: 'BEEF3.SA', n: 'Minerva ON', s: 'Consumo' },
      { t: 'RAIZ4.SA', n: 'Raízen PN', s: 'Energia' },
      { t: 'HAPV3.SA', n: 'Hapvida ON', s: 'Saúde' },
      { t: 'RADL3.SA', n: 'Raia Drogasil ON', s: 'Saúde' },
      { t: 'MDIA3.SA', n: 'M. Dias Branco ON', s: 'Consumo' },
      ...
      { t: 'BBSE3.SA', n: 'BB Seguridade ON', s: 'Financeiro' },
      { t: 'SBSP3.SA', n: 'Sabesp ON', s: 'Utilidades' },
      { t: 'SANB11.SA', n: 'Santander Brasil UNT', s: 'Financeiro' },
      { t: 'TOTS3.SA', n: 'Totvs ON', s: 'Tecnologia' },
      { t: 'ALPA4.SA', n: 'Alpargatas PN', s: 'Varejo' },
    ...
    emerging: [
      // 🇲🇽 MEXICO
      { t: 'AMX', n: 'América Móvil ADR', s: 'Telecom', r: 'Mexico' },
